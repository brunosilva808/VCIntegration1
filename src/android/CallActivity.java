...
public class CallActivity extends AppCompatActivity implements SptCallFragment.OnSptCallFragmentListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        static final int id1 = resources.getIdentifier("call_menu_start_sharing_item", "id", package_name);
        static final int id2 = resources.getIdentifier("call_menu_stop_sharing_item", "id", package_name);
